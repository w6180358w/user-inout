        ...
        try {
            if (writeSheetHolder.getSheetNo() != null) {
            	...
            	try {
					...
					if(writeSheetHolder.getSheetName()!=null && !"".equals(writeSheetHolder.getSheetName().trim())) {
						writeWorkbookHolder.getWorkbook().setSheetName(writeSheetHolder.getSheetNo(), writeSheetHolder.getSheetName().trim());
					}
					writeSheetHolder
                     .setCachedSheet(
